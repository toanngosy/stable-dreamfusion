...
class StableDiffusion(nn.Module):
    def __init__(self, device, sd_version='2.0', pretrained_model_name_or_path=None):
        super().__init__()
        ...
        if pretrained_model_name_or_path is None and self.sd_version == '2.0':
            model_key = "stabilityai/stable-diffusion-2-base"
        elif pretrained_model_name_or_path is None and self.sd_version == '1.5':
            model_key = "runwayml/stable-diffusion-v1-5"
        elif pretrained_model_name_or_path:
            model_key = pretrained_model_name_or_path
        else:
